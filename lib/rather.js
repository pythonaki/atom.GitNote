...
exports.equalGitNoteUri = function(uri1, uri2) {
  const cUri1 = exports.formatGitNoteUri(exports.parseGitNoteUri(uri1), ['hash']);
  const cUri2 = exports.formatGitNoteUri(exports.parseGitNoteUri(uri2), ['hash']);
  return cUri1 === cUri2;
}
